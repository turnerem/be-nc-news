...
describe('/api', () => {
  ...
  describe('/articles', () => {
    ...
    it('GET: 200 can sort by votes ascending, for author icellusedkars only', () => {
      return request(app)
        .get('/api/articles?sort_by=votes:asc&author=icelusedkars')
        .expect(200)
        .then(({body: {articles} = {}}) => {
    ...
    it.only('GET: 200 returns empty array if topic does not exist', () => {
      return request(app)
        ...
        it('GET: 200 returns array of all comments associated with an article_id', () => {
          ...
          .expect(200)
            .then(({body: {comments} = {}}) => {
              ...
              expect(comments).to.be.sortedBy('created_at', 'desc')
            })
        })
